...
class RestaurantService {
  async createRestaurant(data, image) {
    try {
      const { email, password, username, restaurantData, status, restaurantId } = data;
      ...
      const restaurant = await Restaurant.create({
        ...
        restaurantFeatures: parsedData.restaurantFeatures ? JSON.stringify(parsedData.restaurantFeatures) : JSON.stringify([]),
      ...
      return {
        ...
        restaurant: {
          id: restaurant.id,
          restaurantName: restaurant.restaurantName, // Explicitly include restaurantName
